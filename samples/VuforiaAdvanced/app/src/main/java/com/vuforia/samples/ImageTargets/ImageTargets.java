...
public class ImageTargets extends Activity implements SampleAppMenuInterface
{
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                Vuforia.setInitParameters(ImageTargets.this, mVuforiaFlags, "");
                do
                {
    ...
    {
        mTextures.add(Texture.loadTextureFromApk("red.jpg", //TextureTeapotBrass
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("color.jpg", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("red.png", //TextureTeapotRed
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("banana.jpg", getAssets())); //Buildings.jpeg
    }
