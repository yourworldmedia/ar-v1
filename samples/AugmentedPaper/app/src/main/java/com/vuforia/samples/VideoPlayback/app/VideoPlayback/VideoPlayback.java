...
public class VideoPlayback extends Activity implements SampleApplicationControl, SampleAppMenuInterface {
   ...
   // private TextView _textType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //XXX
        mMovieName = "VideoPlayback/regione.mp4"; //andeer andeerHD [BUSINESS] regione cellular
    ...
    public boolean doLoadTrackersData() {
        ...
        // Load the data sets:
        //XXX
        if (!dataSet.load("Regione.xml", STORAGE_TYPE.STORAGE_APPRESOURCE)) { //VirtualButton Regione CellularLineVideo
